...
research: {
  "vilon": {
    ...
    paragraphs: [
      ...
      "De thymus is essentieel voor de ontwikkeling van T-cellen.",
      "Onderzoek toont interactie met genregulerende gebieden.",
      "Vilon speelt een rol bij het verminderen van chronische ontsteking.",
      "Het ondersteunt epitheliale en mucosale regeneratie.",
      "Het beïnvloedt transcriptie en epigenetische processen.",
      "Bij veroudering toont Vilon regeneratief potentieel.",
      "Het verstoort geen natuurlijke regelsystemen.",
      "Vilon is een belangrijk onderzoeksmodel.",
      "Het overstijgt thymus-specifieke biologie.",
      "Het symboliseert fysiologisch gebaseerde peptidewetenschap."
    ],

    bullets: [
      "Ondersteunt thymusregulatie",
      "Verbetert eiwitsynthese",
      "Vermindert chronische ontsteking",
      "Bevordert weefselherstel",
      "Natuurlijke homeostatische werking",
      "Beïnvloedt epigenetica",
      "Verhoogt cellulaire veerkracht",
  ...
  "pinealon": {
    ...
    paragraphs: [
      ...
      "Het werkt op moleculair niveau in hersencellen.",
      "Hersenen zijn gevoelig voor oxidatieve stress.",
      "Pinealon stabiliseert mitochondriale functies.",
      "Het versterkt antioxidatieve enzymen.",
      "Het ondersteunt energie-efficiëntie.",
      "Het reguleert apoptose.",
      "Het beïnvloedt epigenetische processen.",
      "Dierstudies tonen cognitieve verbetering.",
      "Het bevordert synaptisch herstel.",
      "Het vermindert neuro-inflammatie.",
      "Het werkt als neuro-metabole stabilisator."
    ],
    ...
    bullets: [
      ...
      "Apoptoseregulatie",
      "Synaptische ondersteuning",
      "Cognitieve verbetering",
      "Neuro-inflammatiereductie",
  ...
  paragraphs: [
    ...
    "In tegenstelling tot hormonen of stimulerende stoffen verhoogt Testagen de endocriene output niet kunstmatig. In plaats daarvan werkt het als een subtiel intracellulair signaal dat helpt om de natuurlijke homeostase van de testiculaire functie te herstellen, vooral onder omstandigheden van leeftijdsgebonden achteruitgang, oxidatieve stress of metabole verstoring.",

    "De testes spelen een essentiële rol in de endocriene fysiologie door de productie van steroïde hormonen die invloed hebben op metabolisme, botdichtheid, immuunbalans en algemene fysiologische stabiliteit. Na verloop van tijd ondergaat testiculair weefsel progressieve veroudering, gekenmerkt door verminderde antioxidatieve bescherming, mitochondriale disfunctie en veranderde hormoonsynthese.",

    "De onderzoekswaarde van Testagen komt voort uit het potentiële vermogen om deze leeftijdsgerelateerde verstoringen tegen te gaan door genexpressie te beïnvloeden die betrokken is bij celdeling, eiwitsynthese, antioxidatieve systemen en weefselregeneratie.",

    "Epigenetische modulatie vormt een belangrijk aspect van de activiteit van Testagen. Het lijkt een stabiele chromatinestructuur te ondersteunen, de transcriptionele nauwkeurigheid te verbeteren en regulerende markeringen te behouden die eiwitsynthese in reproductieve weefsels sturen.",

    "Experimentele waarnemingen wijzen op een verbeterde weefselorganisatie, versterkte microcirculatie, verminderde fibrose en verhoogde metabole enzymactiviteit in testiculair weefsel behandeld met Testagen.",

    "Oxidatieve stress is een belangrijke factor bij testiculaire veroudering. Onderzoek suggereert dat Testagen antioxidatieve enzymen versterkt, lipideperoxidatie vermindert en de mitochondriale prestaties stabiliseert.",

    "Testagen kan signaalroutes in Sertoli-cellen ondersteunen die metabole harmonie behouden en een gecoördineerde rijping van kiemcellen bevorderen.",

    "Daarnaast kan het bijdragen aan het behoud van de functie van Leydig-cellen door bescherming van steroïdogene pathways en mitochondriale integriteit.",

    "Ondersteuning van de microvasculatuur is een ander belangrijk onderzoeksgebied, aangezien Testagen mogelijk helpt bij het behouden van endotheliale stabiliteit en adequate weefselperfusie.",

    "Over het geheel genomen toont Testagen een sterk potentieel als bioregulerend peptide ter ondersteuning van reproductieve en endocriene weefselresistentie."
  ],

  bullets: [
    "Ondersteunt testiculaire cellulaire homeostase via genregulatie",
    "Beïnvloedt epigenetische omgevingen die geassocieerd zijn met reproductieve levensduur",
    "Versterkt antioxidatieve afweer en vermindert lipideperoxidatie",
    "Bevordert gezondere microvasculaire doorbloeding in testiculair weefsel",
