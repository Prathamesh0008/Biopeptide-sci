export default {
  ...
  countries: [
    ...
    mission: {
      ...
      description:
        "Die weltweite wissenschaftliche Gemeinschaft mit hochreinen Peptiden zu unterstützen, die durch fortschrittliche analytische Dokumentation abgesichert sind – für reproduzierbare Forschung, hochpräzise Experimente und nachhaltigen wissenschaftlichen Fortschritt."
    },

    vision: {
      title: "Unsere Vision",
      description:
        "Ein globaler Maßstab für Peptidforschungsmaterialien zu werden, indem wir wissenschaftliche Verantwortung, höchste Qualitätsstandards und Innovation in den Molekularwissenschaften fördern."
    },

    qualitySection: {
      title: "Qualität • Präzision • Forschungsintegrität",
      description1:
        "Jedes BioPeptide-Produkt durchläuft eine strenge analytische Validierung, einschließlich HPLC-Reinheitsprofilierung, Identitätsbestätigung mittels Massenspektrometrie, Stabilitätsprüfung und chargenspezifischer Dokumentation – für maximale Sicherheit in experimentellen Anwendungen.",
      description2:
        "Unsere Labore arbeiten in kontrollierten Umgebungen mit optimierten Syntheseprozessen und strengen Qualitätsprotokollen – und liefern Peptidmaterialien, die den Anforderungen moderner Forschungsmethoden gerecht werden."
    },

    whyChooseUs: {
      title: "Warum Forscher BioPeptide wählen",
      features: [
        "Hochreine, forschungsgeeignete Peptidmaterialien",
        "Transparente HPLC- und Massenspektrometrie-Dokumentation",
        "Zuverlässige Chargenrückverfolgbarkeit und Reproduzierbarkeit",
        "Ethischer, ausschließlich forschungsbezogener Compliance-Rahmen",
        "Saubere und kontrollierte Laborprozesse",
        "Reaktionsschneller Support für wissenschaftliche Anfragen"
      ]
    },

    ethics: {
      title: "Ethisches und verantwortungsbewusstes Forschungsengagement",
      description:
  ...
  contact: {
    hero: {
      ...
      subtitle:
        "Wir unterstützen Forscher, Labore und wissenschaftliche Teams."
    },

    form: {
      title: "Kontakt aufnehmen",
      description:
        "Füllen Sie das untenstehende Formular aus, und unser Support-Team wird innerhalb von 24 Stunden antworten.",
      fields: {
    ...
    info: {
      ...
      description:
        "Unser Team steht von Montag bis Samstag für Forschungsanfragen, Dokumentation und Bestellunterstützung zur Verfügung.",
      email: "E-Mail",
      phone: "Telefon",
      hours: "Arbeitszeiten",
      research: "Forschungsunterstützung"
    },

    highlights: [
      {
        title: "Hochreine Peptide",
        desc:
          "Jede Charge wird mittels HPLC und Massenspektrometrie geprüft."
      },
      {
        title: "Schneller weltweiter Versand",
        desc:
          "Bestellungen werden schnell für dringende Forschungsanforderungen versandt."
      },
      {
        title: "Experten-Forschungsunterstützung",
        desc:
          "Unser Team unterstützt bei Produktdaten, Dokumentation und Laborhandhabung."
      }
    ]
  },
  navbar: {
...
footer: {
  ...
  brand: {
    description: "Hochreine Forschungspeptide, denen Labore weltweit vertrauen."
  },
...
contact: {
  ...
  disclaimer: {
    copyrightLine: "© 2025BioPeptide.com. Alle Rechte vorbehalten.",
...
cartPage: {
  ...
  shipping: "Versand",
  shippingNote: "Wird beim Checkout berechnet",
  total: "Gesamt",
...
profilePage: {
  title: "Mein Konto",
  subtitle: "Verwalten Sie Ihr Profil, Adressen und Bestellungen",
  logout: "Abmelden",
  customer: "Kunde",
  ...
  accountInfo: { title: "Kontoinformationen" },

  address: {
    title: "Lieferadresse",
    subtitle: "Zuletzt verwendete Adresse",
    edit: "Bearbeiten →"
  },
...
ordersPage: {
  ...
  subtitle: "Verfolgen Sie Ihre Käufe und den Bestellverlauf",
...
checkoutPage: {
  ...
  fields: {
    ...
    email: "E-Mail",
    phone: "Handynummer",
    house: "Haus / Wohnung / Straße",
    area: "Bereich / Orientierungspunkt",
    city: "Stadt",
    state: "Bundesland",
...
images: [
  ...
  "/images/research/vilon/vilon-2.jpg"
    ...
    paragraphs: [
      ...
      "Der Thymus ist eines der wichtigsten Immunorgane des Körpers und verantwortlich für die Entwicklung und Schulung von T-Zellen. Mit zunehmendem Alter unterliegt er einer Involution, die zu einer verminderten Immunleistung führt. Vilon wurde im Zusammenhang mit diesem altersbedingten Prozess identifiziert.",
      "Experimentelle Daten zeigen, dass Vilon mit genomischen Regulationsbereichen interagiert, die mit Zellwachstum, Apoptosekontrolle, antioxidativen Enzymsystemen und Entzündungsmodulation verbunden sind.",
      "Ein besonders relevantes Forschungsfeld ist Vilons Fähigkeit, altersbedingte chronische Entzündungen zu reduzieren, ein Phänomen, das als Inflammaging bekannt ist.",
      "Darüber hinaus zeigt Vilon vielversprechende Effekte bei der epithelialen und mukosalen Regeneration, einschließlich verbesserter Barrierezell-Erneuerung und mikro­zirkulatorischer Stabilität.",
      "Auf molekularer Ebene beeinflusst Vilon grundlegende biologische Prozesse wie Gen­transkription, Chromatin-Remodellierung und epigenetische Regulation.",
      "Im Kontext des Alterns stellt Vilon eines der frühesten Beispiele für ein Peptid dar, das lebensverlängernde Signalwege auf molekularer Ebene beeinflussen kann.",
      "Vilon überschreibt keine körpereigenen Regulationssysteme, sondern liefert ein korrigierendes Feedback-Signal zur Aufrechterhaltung des Gleichgewichts.",
      "Mit wachsendem globalem Interesse an bioregulatorischen Peptiden bleibt Vilon ein zentrales Modell für die Erforschung zellulärer Medizin.",
      "Seine Bedeutung reicht weit über die Thymusbiologie hinaus und unterstreicht das Potenzial natürlicher molekularer Regulatoren.",
      "Zusammenfassend steht Vilon für eine neue Ära der Peptidforschung – geprägt von physiologischer Harmonie statt pharmakologischer Eingriffe."
    ],

    bullets: [
      "Unterstützt thymische Regulation und T-Zell-Entwicklung",
      "Fördert Nukleinsäure- und Proteinsynthese in gestressten Zellen",
      "Moduliert Zytokinbalance und reduziert chronische Entzündungen",
      "Fördert epitheliale und mukosale Geweberegeneration",
      "Wirkt als natürlicher homöostatischer Regulator",
      "Beeinflusst genetische und epigenetische Alterungsprozesse",
      "Verbessert zelluläre Widerstandsfähigkeit",
...
images: [
  ...
  "/images/research/Pinealon/pinealon-brain-2.jpg"
    ...
    paragraphs: [
      ...
      "Im Gegensatz zu Stimulanzien oder Nootropika beeinflusst Pinealon die Gehirngesundheit auf molekularer Ebene, indem es die Proteinsynthese reguliert, die Genaktivität moduliert und die mitochondriale Dynamik in Neuronen und Gliazellen unterstützt.",
      "Das menschliche Gehirn ist besonders anfällig für oxidativen Stress, Energiemangel und mitochondriale Instabilität. Pinealon greift in diesen Prozess ein, indem es Gencluster normalisiert, die für Redox-Gleichgewicht, Apoptoseregulation und mitochondriale Leistungsfähigkeit verantwortlich sind.",
      "Eine der am besten untersuchten Eigenschaften von Pinealon ist seine Fähigkeit, antioxidative Abwehrmechanismen zu stärken, einschließlich der Aktivierung von Enzymen wie Superoxiddismutase und Glutathionperoxidase.",
      "Über die oxidative Regulation hinaus beeinflusst Pinealon maßgeblich die mitochondriale Gesundheit und verbessert die Energieeffizienz in stressbelasteten neuronalen Systemen.",
      "Pinealon moduliert außerdem apoptotische Signalwege, indem es unnötigen programmierten Zelltod reduziert und gleichzeitig gefährdete Neuronen schützt.",
      "Ein besonders relevantes Forschungsfeld ist die epigenetische Aktivität von Pinealon, die zur Wiederherstellung jugendlicher Genexpressionsmuster beitragen kann.",
      "Tierstudien zeigen Verbesserungen der kognitiven Leistung nach Pinealon-Gabe in Modellen von Ischämie, Hypoxie und Alterung.",
      "Darüber hinaus unterstützt Pinealon neurotrophe Faktoren, die für Synapsenstabilität und neuronale Reparatur entscheidend sind.",
      "Pinealon moduliert neuroinflammatorische Prozesse, reduziert Mikroglia-Überaktivierung und stabilisiert das neuroimmune Gleichgewicht.",
      "Aus systemischer Sicht wirkt Pinealon als neuro-metabolischer Stabilisator."
    ],

    bullets: [
      "Unterstützt mitochondriale Stabilität und Energiehaushalt",
      "Stärkt antioxidative Enzymsysteme im Nervengewebe",
      "Reduziert oxidativen Stress und Lipidperoxidation",
      "Moduliert Gene für Apoptose und Zellüberleben",
      "Fördert neurotrophe Unterstützung und Synapsenreparatur",
      "Verbessert kognitive Leistung bei Alterung und Stress",
...
images: [
  ...
  paragraphs: [
    ...
    "Im Gegensatz zu Hormonen erhöht Testagen die endokrine Aktivität nicht künstlich, sondern wirkt als intrazelluläres Regulatorsignal.",
    "Die Hoden spielen eine zentrale Rolle im endokrinen System, produzieren Steroidhormone und unterliegen altersbedingten degenerativen Veränderungen.",
    "Testagen kann altersbedingte Störungen durch Regulation der Genexpression ausgleichen.",
    "Ein wesentlicher Aspekt ist die epigenetische Stabilisierung der Genaktivität.",
    "Studien zeigen eine verbesserte Gewebeorganisation und Mikrozirkulation.",
    "Testagen reduziert oxidativen Stress und stabilisiert mitochondriale Funktionen.",
    "Es unterstützt die Signalwege der Sertoli-Zellen.",
    "Leydig-Zellen profitieren durch den Erhalt der Steroidogenese.",
    "Auch die mikrovaskuläre Versorgung wird positiv beeinflusst.",
    "Testagen gilt als vielversprechendes Forschungspeptid für reproduktive Langlebigkeit."
  ],

  bullets: [
    "Unterstützt die zelluläre Homöostase der Hoden",
    "Fördert epigenetische Stabilität",
    "Reduziert oxidativen Stress",
    "Verbessert die Mikrozirkulation",
    "Stabilisiert Sertoli- und Leydig-Zellen",
    "Schützt mitochondriale Funktionen",
...
"/images/research/Bronchogen/Bronchogen2.jpg"
  ...
  paragraphs: [
    ...
    "Das Atmungssystem ist ständig Umweltbelastungen ausgesetzt.",
    "Bronchogen unterstützt die Reparatur des Epithels.",
    "Es moduliert entzündliche Signalwege.",
    "Oxidativer Stress wird reduziert.",
    "Die mukoziliäre Funktion wird unterstützt.",
    "Die Mikrozirkulation im Lungengewebe wird stabilisiert.",
    "Es reguliert Zellwachstum und Apoptose.",
    "Bronchogen unterstützt die mitochondriale Funktion.",
    "Fibroblastenaktivität wird reguliert.",
    "Es trägt zur langfristigen Lungengesundheit bei."
  ],

  bullets: [
    "Unterstützt die Reparatur des Bronchialepithels",
    "Reguliert Entzündungsprozesse",
    "Reduziert oxidativen Stress",
    "Verbessert die Mikrozirkulation",
    "Unterstützt die mukoziliäre Clearance",
    "Reguliert die extrazelluläre Matrix",
    "Schützt mitochondriale Funktionen",
...
images:[
  ...
  paragraphs: [
    ...
    "Das Herz benötigt kontinuierliche Energieproduktion.",
    "Cardiogen unterstützt genetische Schutzmechanismen.",
    "Es stabilisiert mitochondriale Funktionen.",
    "Reduziert oxidativen Stress im Herzgewebe.",
    "Moduliert entzündliche Signalwege.",
    "Unterstützt die Mikrozirkulation.",
    "Reguliert die extrazelluläre Matrix.",
    "Fördert DNA-Reparaturprozesse.",
    "Unterstützt rhythmische Herzkontraktionen."
  ],

  bullets: [
    "Unterstützt mitochondriale Energieproduktion",
    "Reduziert oxidativen Stress",
    "Reguliert Entzündungen im Herz",
    "Fördert die Gefäßstabilität",
    "Begrenzt übermäßige Fibrose",
    "Verbessert Zellorganisation",
...
images:[
  ...
  paragraphs: [
    ...
    "Peptide wirken als natürliche Signalmoleküle zur Steuerung der Gewebereparatur.",
    "Sie sind tief in zelluläre Prozesse wie Transkription und Differenzierung integriert.",
    "Peptide regulieren die extrazelluläre Matrix und Fibroblastenaktivität.",
    "Auf molekularer Ebene steuern sie die Genexpression.",
    "Sie helfen, entzündliche Prozesse auszugleichen.",
    "Peptide unterstützen die mitochondriale Energieproduktion.",
    "Sie fördern die Angiogenese und Mikrozirkulation.",
    "Peptide beeinflussen die Stammzellaktivierung.",
    "In der Haut fördern sie Kollagen und Struktur.",
    "Im Bewegungsapparat unterstützen sie Reparaturprozesse.",
    "Epithelgewebe profitiert von verbesserter Barrierefunktion.",
    "Im Nervensystem unterstützen sie neuronale Stabilität."
  ],

  bullets: [
    "Unterstützt Gewebereparatur",
    "Reguliert Kollagen und Matrix",
    "Reduziert chronische Entzündung",
    "Verbessert mitochondriale Energie",
    "Fördert Durchblutung",
    "Erhöht antioxidativen Schutz",
    "Unterstützt Stammzellfunktion",
...
images:[
  ...
  paragraphs: [
    ...
    "Peptide regulieren Energieproduktion und hormonelle Kommunikation.",
    "Sie beeinflussen die mitochondriale Funktion und ATP-Synthese.",
    "Peptide steuern die Expression metabolischer Gene.",
    "Sie verbessern die Glukoseverwertung und Insulinsensitivität.",
    "Sie regulieren den Fettstoffwechsel.",
    "Endokrine Peptide koordinieren Organfunktionen.",
    "Schilddrüsenpeptide beeinflussen den Grundumsatz.",
    "Nebennierenpeptide regulieren Stressreaktionen.",
    "Appetitpeptide steuern Hunger und Sättigung.",
    "Peptide unterstützen die Gefäßgesundheit.",
    "Sie reduzieren chronische Entzündung.",
    "Sie helfen, hormonelle Alterung auszugleichen."
  ],
  ...
  bullets: [
    ...
    "Stabilisiert Hormonsignale",
    "Reduziert Entzündung",
    "Verbessert Mikrozirkulation",
    "Synchronisiert Stoffwechselrhythmen",
...
images:[
  ...
  paragraphs: [
    ...
    "Peptide unterstützen den neuronalen Energiestoffwechsel.",
    "Sie verbessern synaptische Kommunikation.",
    "Sie fördern neurotrophe Faktoren.",
    "Sie regulieren Gliazellen und Entzündung.",
    "Sie stabilisieren die Blut-Hirn-Schranke.",
    "Sie modulieren Neurotransmittersysteme.",
    "Sie beeinflussen epigenetische Prozesse.",
    "Sie stärken mitochondriale Funktion.",
    "Sie schützen vor stressbedingten Schäden.",
    "Sie unterstützen Gedächtnisbildung."
  ],

  bullets: [
    "Verbessert synaptische Plastizität",
    "Unterstützt neuronale Energie",
    "Fördert neuronale Reparatur",
    "Stabilisiert Neurotransmitter",
    "Reduziert Neuroentzündung",
...
images:[
  ...
  paragraphs: [
    ...
    "Peptide modulieren Immunaktivität ohne Überstimulation.",
    "Chronische Entzündung beschleunigt Alterungsprozesse.",
    "Peptide beeinflussen zelluläre Immun-Signalwege.",
    "Zytokin-Gleichgewicht ist entscheidend für Immunstabilität.",
    "Peptide regulieren Makrophagen und Immunzellen.",
    "Sie reduzieren oxidativen Stress.",
    "Sie beeinflussen Darm-Immunsystem-Interaktionen.",
    "Sie unterstützen gesundes Immunaltern.",
    "Sie stabilisieren Gefäßentzündungen.",
    "Sie regulieren Bindegewebsumbau.",
    "Sie fördern Wundheilung.",
    "Sie unterstützen neuroimmunes Gleichgewicht."
  ],

  bullets: [
    "Reguliert Zytokinbalance",
    "Reduziert chronische Entzündung",
    "Stärkt antioxidative Abwehr",
    "Moduliert Immunzellen",
    "Unterstützt Gefäßgesundheit",
    "Fördert Gewebereparatur",
    "Stabilisiert Neuroimmunität",
...
images:[
  ...
  paragraphs: [
    ...
    "Alterung entsteht durch Stress, Entzündung und metabolische Erschöpfung.",
    "Peptide stabilisieren epigenetische Signale.",
    "Sie unterstützen DNA-Reparaturmechanismen.",
    "Sie erhalten Proteinhomöostase.",
    "Sie schützen mitochondriale Funktion.",
    "Sie reduzieren chronische Entzündung.",
    "Sie unterstützen Telomerstabilität indirekt.",
    "Sie regulieren zelluläre Seneszenz.",
    "Sie fördern Geweberegeneration.",
    "Sie erhalten Kollagen- und Elastinstruktur.",
    "Sie unterstützen hormonelle Stabilität."
  ],

  bullets: [
    "Epigenetische Stabilität",
    "Mitochondriale Energieerhaltung",
    "DNA-Schutz",
    "Entzündungsreduktion",
    "Proteinqualität",
    "Gewebestruktur",
    "Zellerneuerung",
    "Chronobiologische Balance"
  ]
}
...
orderSuccess: {
  ...
  subtitle: "Vielen Dank für Ihre Bestellung. Wir beginnen in Kürze mit der Bearbeitung.",
