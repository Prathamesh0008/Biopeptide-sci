...
export const INFO_ARTICLES = [
...

  {
    ...
    content: [
      ...
      "The synthesis process includes: 1) Resin attachment, 2) Amino-acid coupling, 3) Cleavage, 4) HPLC purification, 5) MS validation.",
      "BioPeptide ensures >99% purity in all batches.",
      "SPPS allows rapid production of peptides with precise sequence control while minimizing side reactions.",
      "Modern synthesis systems use automated coupling cycles to ensure uniform reaction efficiency across all amino acids.",
      "After cleavage, peptides undergo purification to remove truncated fragments and unreacted residues, ensuring laboratory-grade accuracy.",
      "Advanced analytical tools confirm molecular weight, purity percentage, and structural integrity."
    ]
  },
