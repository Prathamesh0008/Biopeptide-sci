  ...
  <ul className="mt-3 space-y-1 text-gray-700 text-sm sm:text-base">
    {t.overviewPoints?.map((point, i) => (
      ...
      <li key={i}>• {point}</li>
            ...
            {/* Science */}
            <div className="mt-10">
              <h3 className="text-lg sm:text-xl font-bold text-gray-900">{t.scienceTitle}</h3>
             <ul className="mt-3 text-gray-700 text-sm sm:text-base space-y-2">
  {t.sciencePoints?.map((point, i) => (
    <li key={i}>• {point}</li>
  ))}
</ul>
            ...
            {/* Stability */}
            <div className="mt-10">
              <h3 className="text-lg sm:text-xl font-bold text-gray-900">{t.stabilityTitle}</h3>
              <ul className="mt-3 text-gray-700 text-sm sm:text-base space-y-2">
  {t.stabilityPoints?.map((point, i) => (
    <li key={i}>• {point}</li>
  ))}
</ul>
            ...
            {/* FAQ */}
            <div className="mt-12">
              <h3 className="text-lg sm:text-xl font-bold text-gray-900">{t.faqTitle}</h3>
