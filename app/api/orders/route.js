...
//   // item.slug OR item.productId (use what you have)
//   const product = await Product.findOne({
//     slug: item.slug, // 🔁 change if you use productId instead
//   });

//   if (!product) {
//     return Response.json(
//       { ok: false, error: `${item.name} not found` },
//       { status: 400 }
//     );
//   }
...
//   if (!product.inStock) {
//     return Response.json(
//       { ok: false, error: `${item.name} is out of stock` },
//       { status: 400 }
//     );
//   }
// }
