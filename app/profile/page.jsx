...
export default function ProfilePage() {
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12">
    ...
    <div className="grid lg:grid-cols-4 gap-8">
      ...
      {/* LEFT – PROFILE CARD */}
      <div className="lg:col-span-1 bg-white/90 backdrop-blur rounded-2xl shadow-xl border p-6">
        <div className="flex flex-col items-center text-center mb-6">
          <div className="w-20 h-20 rounded-full bg-gradient-to-r from-bioBlue to-bioGreen
        ...
        <button
          ...
          className="mt-8 w-full py-3 rounded-full font-semibold text-white
            bg-gradient-to-r from-bioBlue to-bioGreen hover:opacity-90 transition"
        >
          Logout
        </button>
      </div>
