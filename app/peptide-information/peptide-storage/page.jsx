  ...
  return (
    <>
      ...
      <main className="max-w-5xl mx-auto px-6 py-10">
        ...
        {/* CONTENT */}
        <div className="prose prose-gray max-w-none text-gray-800">
          <h2>{t.sections.bestPractices.title}</h2>
          <p>{t.sections.bestPractices.paragraph1}</p>
          <p>{t.sections.bestPractices.paragraph2}</p>
          <p>{t.sections.bestPractices.paragraph3}</p>

          <h2>{t.sections.freezeThaw.title}</h2>
          <p>{t.sections.freezeThaw.paragraph}</p>

          <h2>{t.sections.oxidation.title}</h2>
          <p>{t.sections.oxidation.paragraph1}</p>
          <p>{t.sections.oxidation.paragraph2}</p>

          <h2>{t.sections.aliquoting.title}</h2>
          <p>{t.sections.aliquoting.paragraph}</p>

          <h2>{t.sections.solutionStorage.title}</h2>
          <p>{t.sections.solutionStorage.paragraph1}</p>
          <p>{t.sections.solutionStorage.paragraph2}</p>

          <h2>{t.sections.containers.title}</h2>
