...
export default function PeptideInformationPage() {
  const { translations, loading } = useLanguage(); // `useLanguage` hook should be called at the top
  const [query, setQuery] = useState(""); // `useState` hook should be called after `useLanguage`
                ...
                >
                  <div className="flex gap-4 items-start">
                    <div className="relative w-[72px] h-[72px] flex-shrink-0">
                      <Image
                        src={a.img || '/images/default-image.jpg'} // Fallback image
                        alt={a.title}
                        fill
