    ...
    <>
      ...
      <main className="max-w-5xl mx-auto px-6 py-10">
        ...
        <div className="prose prose-gray max-w-none text-gray-800">
          ...
          <p>{t.sections.whatIs.paragraph1}</p>
          <p>{t.sections.whatIs.paragraph2}</p>

          <h2>{t.sections.formation.title}</h2>
          <p>{t.sections.formation.paragraph1}</p>
          <p>{t.sections.formation.paragraph2}</p>

          <h2>{t.sections.history.title}</h2>
          <p>{t.sections.history.paragraph}</p>

          <h2>{t.sections.terminology.title}</h2>
          <ul>
          ...
          <h2>{t.sections.importantTerms.title}</h2>
          <ul>
